...
export function JourneySection() {
  return (
    <section className="w-full pt-64 md:pt-96 pb-24 bg-[#FBFAF7] relative overflow-hidden">
        <div className="max-w-desktop mx-auto px-4 sm:px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-32 items-start">
            ...
            <div className="w-full lg:w-7/12 relative pl-4 sm:pl-12">
              <div className="absolute left-[26px] sm:left-[22px] top-8 bottom-8 w-[2px] bg-gradient-to-b from-brand-purple via-brand-blue to-brand-purple hidden sm:block opacity-20"></div>
